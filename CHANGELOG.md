...
* ship local_cmds.json/local_components_cache.json as package data ([434fe63](https://github.com/zalf-rpm/mas_python_fbp/commit/434fe63cc57108854801ceadedccde1703d8f9ea))
...
* attach sentinel values also if they weren't used on creation of an ([a83747b](https://github.com/zalf-rpm/mas_python_fbp/commit/a83747be0985a8e6e68c493fd00ab4e3a95306d0))
...
* run pixi lock to sync lockfile ([e2dfcd3](https://github.com/zalf-rpm/mas_python_fbp/commit/e2dfcd375b8633a76cdc6e53cfb7b74f944bc920))
