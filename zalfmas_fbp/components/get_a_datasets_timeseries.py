...
async def run_component(port_infos_reader_sr: str, config: dict):
    ...
    while ports["ds"] and ports["out"]:
        try:
            ...
            ports["out"].write(value=fbp_capnp.IP.new_message(type="openBracket"))
            while True:
            ...
            ports["out"].write(value=fbp_capnp.IP.new_message(type="closeBracket"))
